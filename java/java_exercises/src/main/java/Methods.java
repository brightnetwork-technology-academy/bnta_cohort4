public class Methods {
    ...
    /**
     * Exercise 3: A method which takes a string as an argument, capitalises the *first* letter and returns the
     * capitalised string
     */

    /**
     * Exercise 4: A method which takes two numbers as arguments, checks if they are the same and returns the appropriate
     * boolean value.
     *
    ...
    /**
     * Exercise 5: A method which takes two numbers as arguments and *prints* one of:
    ...
    /**
     * Exercise 7: A method which takes a sentence as an argument, counts the number of words in the array and prints
     * "The sentence contains X words".
     *
     * HINT 1: One of the methods to do this already exists within Java. Research the Java String documentation to see
     * what you can do with strings (https://docs.oracle.com/javase/7/docs/api/java/lang/String.html)
     *
     * HINT 2: Remember what you've done already, you might be able to reuse one of your methods here...
     */
